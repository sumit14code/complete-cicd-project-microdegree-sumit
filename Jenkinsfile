pipeline {
    ...
    environment {
        DOCKER_TAG = "20241003"
        IMAGE_NAME = "sumithanagandi/fullstack"
    ...
    stages {
        ...
        stage('Deploy To Kubernetes') {
            steps {
                withKubeConfig(caCertificate: '', clusterName: 'microdegree-cluster', contextName: '', credentialsId: 'kube', namespace: 'microdegree', restrictKubeConfigAccess: false, serverUrl: 'https://EE0D3834EDFC0AFA7BE1485E5736A7B8.gr7.ap-south-1.eks.amazonaws.com') {
